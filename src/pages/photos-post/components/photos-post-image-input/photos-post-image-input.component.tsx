...
type IPhotosPostImageInputComponentProps = {
  index: number;
};

// 2x2 그리드에서, 각 index의 upload 버튼과 preview를 렌더링함
export const PhotosPostImageInputComponent: FC<
  IPhotosPostImageInputComponentProps
> = ({ index }) => {
      ...
      render={({ field: { value, onChange } }) => {
        ...
        return (
          <UploadDiv>
            ...
            <StyledInput type="file" onChange={handleFileUpload} />
          </UploadDiv>
        );
      }}
    />
